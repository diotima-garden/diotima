...
Read this before implementing a new external integration or modifying `plugins/anki-mcp/`.
...
Read `plugins/anki-mcp/README.md` — it covers tool registration, server structure, and
