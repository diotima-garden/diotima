...
- **Real sample data to build against.** A snapshot of one of my actual decks lives in
  [`deck_quality_bootstrapping/`](https://github.com/diotima-garden/spanish/tree/main/deck_quality_bootstrapping/)
  in the spanish grove repo (`diotima-garden/spanish`, one of the independent grove repos this
  project composes — see `CLAUDE.md`)
...
- **An idea bank.** [`creative-usages.md`](https://github.com/diotima-garden/language/blob/main/creative-usages.md)
  (in the `language` grove spanish inherits from) is my rough,
