# Customer brief — "Replace LLM orchestration with deterministic code where an LLM isn't needed"
...
system with deep integration of a spaced-repetition database (Anki) to help a person actually
learn. I use it every day, & the architecture is genuinely good.
